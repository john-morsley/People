...
namespace PagedListTests
{
    public class Tests
    {
        ...
        //[Test]
        //public void Given_A_Paged_List___When_It_has_One_User___Then_Everything_Should_Be_Default()
        //{
        //    // Arrange...
        ...
        {
            // Arrange...
            var john = GetUserResponse(TestUsers.John);
            var sut = GetPagedList(john);
            sut.CurrentPage = 1;
            sut.PageSize = 1;
            sut.TotalPages = 1;
            ...
            var actualJson = CleanJson(JsonSerializer.Serialize(sut, serializeOptions));
        ...
        public void Given_A_Paged_List_With_Three_User___When_Serializing___Then_The_Resultant_JSON_Should_Be_Valid()
        {
            // Arrange...
            var john = GetUserResponse(TestUsers.John);
            var fabio = GetUserResponse(TestUsers.Fabio);
            var glen = GetUserResponse(TestUsers.Glen);
            var sut = GetPagedList(new List<Users.API.Models.Response.v1.UserResponse>() { john, fabio, glen });
            sut.CurrentPage = 2;
            sut.PageSize = 1;
            sut.TotalPages = 3;
        ...
        //    var sut = GetPagedList(new List<Users.API.Models.Response.v1.UserResponse>() { user1, user2, user3 });
        ...
        public void Given_Serialized_JSON___When_Deserializing___Then_An_Empty_Paged_List_Should_Result()
        {
            ...
            deserializeOptions.Converters.Add(new Users.API.Models.Shared.PagedListJsonConverter());
            var pagedList = JsonSerializer.Deserialize<Users.API.Models.Shared.PagedList<Users.API.Models.Response.v1.UserResponse>>(json, deserializeOptions);
        ...
        private Users.API.Models.Shared.PagedList<Users.API.Models.Response.v1.UserResponse> GetPagedList(int numberOfUsers = 0)
        {
            var pagedList = new Users.API.Models.Shared.PagedList<Users.API.Models.Response.v1.UserResponse>();
            //sut.Add(new Users.API.Models.Response.v1.UserResponse() { });
        ...
        private Users.API.Models.Shared.PagedList<Users.API.Models.Response.v1.UserResponse> GetPagedList(
            Users.API.Models.Response.v1.UserResponse user)
        {
            var pagedList = new Users.API.Models.Shared.PagedList<Users.API.Models.Response.v1.UserResponse>();
            pagedList.Add(user);
            return pagedList;
        ...
        private Users.API.Models.Shared.PagedList<Users.API.Models.Response.v1.UserResponse> GetPagedList(
            IList<Users.API.Models.Response.v1.UserResponse> users)
        {
            var pagedList = new Users.API.Models.Shared.PagedList<Users.API.Models.Response.v1.UserResponse>();
        ...
        private Users.API.Models.Response.v1.UserResponse GetUserResponse()
        {
            return _autoFixture.Create<Users.API.Models.Response.v1.UserResponse>();
        }

        private Users.API.Models.Response.v1.UserResponse GetUserResponse(Guid id, string firstName, string lastName)
        {
        ...
        private Users.API.Models.Response.v1.UserResponse GetUserResponse(TestUsers user)
        {
            switch (user)
            {
                case TestUsers.John: return GetUserResponse(Guid.Parse("11111111-1111-1111-1111-111111111111"), "John", "Morsley");
                case TestUsers.Fabio: return GetUserResponse(Guid.Parse("22222222-2222-2222-2222-222222222222"), "Fabio", "Sereno");
                case TestUsers.Glen: return GetUserResponse(Guid.Parse("33333333-3333-3333-3333-333333333333"), "Glen", "Clark");
                case TestUsers.Adam: return GetUserResponse(Guid.Parse("44444444-4444-4444-4444-444444444444"), "Adam", "Bray");
                case TestUsers.Matt: return GetUserResponse(Guid.Parse("55555555-5555-5555-5555-555555555555"), "Matt", "Dumont");
                case TestUsers.Paul: return GetUserResponse(Guid.Parse("66666666-6666-6666-6666-666666666666"), "Paul", "Martin");
                case TestUsers.Thomas: return GetUserResponse(Guid.Parse("77777777-7777-7777-7777-777777777777"), "Thomas", "Grimshaw");
            }
