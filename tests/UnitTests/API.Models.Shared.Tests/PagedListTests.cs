...
public class PagedListTests
{
    ...
    public void Given_A_Paged_List_With_Three_User___When_Serializing___Then_The_Resultant_JSON_Should_Be_Valid()
    {
        ...
        var pagedList = GetPagedList(new List<Users.API.Models.Response.v1.UserResponse>() { john, fabio, glen });
    ...
    private Users.API.Models.Response.v1.UserResponse GetUserResponse(TestUsers user)
    {
        switch (user)
        {
            case TestUsers.John: return GetUserResponse(Guid.Parse("11111111-1111-1111-1111-111111111111"), "John", "Morsley", Sex.Male, Gender.Cisgender);
            case TestUsers.Fabio: return GetUserResponse(Guid.Parse("22222222-2222-2222-2222-222222222222"), "Fabio", "Sereno", Sex.Male, Gender.Cisgender);
            case TestUsers.Glen: return GetUserResponse(Guid.Parse("33333333-3333-3333-3333-333333333333"), "Glen", "Clark", Sex.Male, Gender.Cisgender);
            case TestUsers.Adam: return GetUserResponse(Guid.Parse("44444444-4444-4444-4444-444444444444"), "Adam", "Bray", Sex.Male, Gender.Cisgender);
            case TestUsers.Matt: return GetUserResponse(Guid.Parse("55555555-5555-5555-5555-555555555555"), "Matt", "Dumont", Sex.Male, Gender.Cisgender);
            case TestUsers.Paul: return GetUserResponse(Guid.Parse("66666666-6666-6666-6666-666666666666"), "Paul", "Martin", Sex.Male, Gender.Cisgender);
            case TestUsers.Thomas: return GetUserResponse(Guid.Parse("77777777-7777-7777-7777-777777777777"), "Thomas", "Grimshaw", Sex.Male, Gender.Cisgender);
        }
